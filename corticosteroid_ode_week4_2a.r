###########################################################
# Differential equations for fifth-generation model of corticosteroid receptor dynamics
# model taken from Ramakrishnan 2002
# model has been adjusted to remove auto-regulation of mRNA production
# ---------------------------------------------------------
# Course: Thema 8
# -----------------------
...
# four-equations dynamical system
# --------------------------------------------------------------------
fifthGenerationModel <- function(t, x, parms) 
{
  ...
  with(as.list(parms),
  {
     dRm <- ksyn_rm - kdgr_rm*Rm    # *(1-DRN/(IC50 + DRN))  part has been removed; approximation can be obtained by fixing IC50 to very large value
...
pdf("Week4_2a_noautoregulation.pdf")
